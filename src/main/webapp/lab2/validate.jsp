...
<jsp:useBean id="login" scope="request" class="com.xinxiang.lab2.login"></jsp:useBean>
...
<%
   //todo 3: use if check username is admin and password is admin
    if (request.getParameter("username").equals("admin") && request.getParameter("username").equals("admin")){
