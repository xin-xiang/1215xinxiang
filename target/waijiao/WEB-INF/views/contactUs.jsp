...
<script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script>
    ...
    //鏍囨敞鐐规暟缁?
    var markerArr = [{title:"华东交通大学",content:"华东交通大学<br/>江西省南昌市经济开发区双港东大街808号华东交通大学北区教31栋<br/>(0791)87046576",point:"115.873619|28.750131",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //鍒涘缓marker
    function addMarker(){
