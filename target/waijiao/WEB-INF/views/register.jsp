...
<form method="post" action="register">
    <input type="text" name="id" placeholder="Id" /><input type="text" name="username" placeholder="Username" />  <input type="password" name="password" placeholder="password" />   <input type="text" name="email" placeholder="Email">
